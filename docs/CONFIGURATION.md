...
| `LESSON_PROMPT_VERSION` | `lesson-v3` | Forma parte de la cache key de lecciones; cambiarla invalida la cache existente por diseño. |
...
| Variable | Default | Descripción |
|---|---|---|
| `APP_VERSION` | `1.1.0` | Versión mostrada en `GET /api/system/status` y en la pantalla de Configuración. Sin automatización de semver. |
